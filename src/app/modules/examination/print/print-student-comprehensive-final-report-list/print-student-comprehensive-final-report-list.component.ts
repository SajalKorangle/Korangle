...
@Component({
    selector: 'app-print-student-comprehensive-final-report-list',
    templateUrl: './print-student-comprehensive-final-report-list.component.html',
    styleUrls: ['./print-student-comprehensive-final-report-list.component.css'],
})
export class PrintStudentComprehensiveFinalReportListComponent implements OnInit, OnDestroy, AfterViewChecked {
    ...
    printStudentComprehensiveFinalReportListComponentSubscription: any;

    constructor(private cdRef: ChangeDetectorRef) { }

    ngOnInit(): void {
        this.printStudentComprehensiveFinalReportListComponentSubscription =
            EmitterService.get('print-student-comprehensive-final-report-list-component').subscribe(value => {
    ...
    ngOnDestroy(): void {
        this.printStudentComprehensiveFinalReportListComponentSubscription.unsubscribe();
        this.subjectList = null;
        this.extraFieldList = null;
        this.studentFinalReportList = null;
    }
