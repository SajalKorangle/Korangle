...
import { AddStudentOldServiceAdapter } from './add-student-old-service.adapter';
...
@Component({
  selector: 'add-student-old',
  templateUrl: './add-student-old.component.html',
  styleUrls: ['./add-student-old.component.css'],
    providers: [ ClassService, BusStopService, StudentOldService, SubjectOldService, ExaminationOldService ],
})

export class AddStudentOldComponent implements OnInit {
    ...
    serviceAdapter: AddStudentOldServiceAdapter;
    ...
    ngOnInit(): void {
        ...
        this.serviceAdapter = new AddStudentOldServiceAdapter();
