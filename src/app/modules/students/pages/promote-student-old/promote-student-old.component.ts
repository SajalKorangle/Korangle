...
import { PromoteStudentOldServiceAdapter } from './promote-student-old-service.adapter';
...
@Component({
  selector: 'promote-student-old',
  templateUrl: './promote-student-old.component.html',
  styleUrls: ['./promote-student-old.component.css'],
    providers: [ StudentOldService, ClassService, SubjectOldService, ExaminationOldService ],
})

export class PromoteStudentOldComponent implements OnInit {
    ...
    serviceAdapter: PromoteStudentOldServiceAdapter;
    ...
    ngOnInit(): void {
        ...
        this.serviceAdapter = new PromoteStudentOldServiceAdapter();
