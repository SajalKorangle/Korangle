...
const routes: Routes = [
    ...
    {
        path: 'view_profile',
        loadChildren: 'app/modules/job/view-profile/view-profile.module#ViewProfileModule',
        data: {moduleName: 'job'},
    },
    {
        path: 'view_attendance',
        loadChildren: 'app/modules/job/view-attendance/view-attendance.module#ViewAttendanceModule',
        data: {moduleName: 'job'},
    },
    {
        path: 'view_payment',
        loadChildren: 'app/modules/job/view-payment/view-payment.module#ViewPaymentModule',
        data: {moduleName: 'job'},
    },
    {
        path: 'apply_leave',
        loadChildren: 'app/modules/job/apply-leave/apply-leave.module#ApplyLeaveModule',
        data: {moduleName: 'job'},
    },
