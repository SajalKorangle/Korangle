...
// '<view-attendance *ngIf="user.section.subRoute===\'view_attendance\'" [user]="user" [studentId]="user.section.student.id"></view-attendance>',
    ...
    {
        path: 'view_profile',
        loadChildren: 'app/modules/parent/view-profile/view-profile.module#ViewProfileModule',
        data: {moduleName: 'parent'},
    },
    {
        path: 'view_fee',
        loadChildren: 'app/modules/parent/view-fee/view-fee.module#ViewFeeModule',
        data: {moduleName: 'parent'},
    },
    {
        path: 'view_marks',
        loadChildren: 'app/modules/parent/view-marks/view-marks.module#ViewMarksModule',
        data: {moduleName: 'parent'},
    },
    {
        path: 'view_attendance',
        loadChildren: 'app/modules/parent/view-attendance/view-attendance.module#ViewAttendanceModule',
        data: {moduleName: 'parent'},
    },
