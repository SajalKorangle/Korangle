...
export class StudentRemarksServiceAdapter {

    vm: StudentRemarksComponent;
    ...
    initializeAdapter(vm: StudentRemarksComponent): void {
        this.vm = vm;
    }
    ...
    getStudentRemarkDetails(): void {
        ...
        Promise.all([
            this.vm.customReportCardService.getObjectList(this.vm.customReportCardService.student_remarks,student_remark_data),
        ]).then(value => {
    ...
    updateStudentRemark(studentSection: any, newRemark: any, element: any): void {
        ...
        if (this.vm.getStudentRemark(studentSection) != newRemark) {
            ...
            if (prev_student_remark) {
                ...
                service_list.push(this.vm.customReportCardService.updateObject(this.vm.customReportCardService.student_remarks,student_remark_data));
            } else {
                let student_remark_data = {
                ...
                service_list.push(this.vm.customReportCardService.createObject(this.vm.customReportCardService.student_remarks,student_remark_data));
            }
