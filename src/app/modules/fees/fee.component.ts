...
@Component({
    template: '<collect-fee *ngIf="user.section.subRoute===\'collect_fee\'" [user]="user"></collect-fee>' +
    ...
    '<give-discount *ngIf="user.section.subRoute===\'give_discount\'" [user]="user"></give-discount>' +
