# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2018-05-06 10:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rte', models.BooleanField(default=False, verbose_name='rte_allowed')),
                ('onlyNewStudent', models.BooleanField(default=False, verbose_name='only_new_student')),
                ('classFilter', models.BooleanField(default=False, verbose_name='class_filter')),
                ('busStopFilter', models.BooleanField(default=False, verbose_name='bus_stop_filter')),
                ('frequency', models.CharField(choices=[('MONTHLY', 'Monthly'), ('QUATERLY', 'Quaterly'), ('YEARLY', 'Yearly')], default='YEARLY', max_length=10)),
        ...
        migrations.AlterUniqueTogether(
            name='studentmonthlyfeecomponent',
            unique_together=set([('parentStudentFeeComponent', 'parentMonth')]),
        ),
        migrations.AlterUniqueTogether(
            name='studentfeecomponent',
            unique_together=set([('parentStudent', 'parentFeeDefinition')]),
        ),
        migrations.AlterUniqueTogether(
            name='schoolfeecomponent',
            unique_together=set([('parentFeeDefinition', 'title')]),
        ),
        migrations.AlterUniqueTogether(
            name='feedefinition',
            unique_together=set([('parentSchool', 'parentSession', 'parentFeeType')]),
        ),
    ]
