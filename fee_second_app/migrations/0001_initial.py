# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2018-04-11 12:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parentSchoolFeeComponent', models.ForeignKey(default=0, on_delete=django.db.models.deletion.PROTECT, to='fee_second_app.SchoolFeeComponent', verbose_name='parentSchoolFeeComponent')),
                ('parentStudent', models.ForeignKey(default=0, on_delete=django.db.models.deletion.PROTECT, to='student_app.Student', verbose_name='parentStudent')),
            ],
            options={
