# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2018-04-14 09:51
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('monthName', models.CharField(choices=[('APRIL', 'April'), ('MAY', 'May'), ('JUNE', 'June'), ('JULY', 'July'), ('AUGUST', 'August'), ('SEPTEMBER', 'September'), ('OCTOBER', 'October'), ('NOVEMBER', 'November'), ('DECEMBER', 'December'), ('JANUARY', 'January'), ('FEBRUARY', 'February'), ('MARCH', 'March')], default='APRIL', max_length=10)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            name='SchoolFeeComponentMonthly',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount', models.IntegerField(default=0, verbose_name='amount')),
        ...
        migrations.CreateModel(
            name='StudentFeeComponentMonthly',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount', models.IntegerField(default=0, verbose_name='amount')),
                ('parentMonth', models.ForeignKey(default=1, on_delete=django.db.models.deletion.PROTECT, to='fee_second_app.Month', verbose_name='parentMonth')),
