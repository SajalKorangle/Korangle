...
from .views import student_data_view, class_student_list_view, class_list_view, new_student_data_view, new_fee_receipt_view, fee_list_view, update_student_view
