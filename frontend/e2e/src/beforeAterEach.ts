...
export class BeforeAfterEach {
    ...
    static async beforeEach() {
        ...
        await BeforeAfterEach.page.type('#username', '1234512345'); // Types instantly
        await BeforeAfterEach.page.type('#password', '1234512345', {delay: 100}); // Types slower, like a user
