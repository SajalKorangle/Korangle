...
export interface APP_MODEL_STRUCTURE_INTERFACE {
    ...
    fees_third_app: 'FeeReceipt' | 'SubFeeReceipt' | 'Discount' | 'SubDiscount' | 'FeeReceiptOrder' | 'StudentFee' | 'FeeSchoolSettings' | 'ViewDefaulterPermissions' | 'FeeReceiptBook' | 'CustomFilterFee' | 'FeeType' | 'SchoolFeeRule';
