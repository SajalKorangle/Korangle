...
@Injectable()
export class GenericServiceObject extends RestApiGateway {
    ...
    createObject<T extends keyof APP_MODEL_STRUCTURE_INTERFACE>(app_name: T, model_name: APP_MODEL_STRUCTURE_INTERFACE[T], data: any): Promise<any> {
        ...
        return super.postData(data, this.getBaseUrl(), { app_name, model_name }).then(JSON_OBJECT_RESPONSE_PARSER);
    }
