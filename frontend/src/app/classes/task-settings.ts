...
interface Options { // additional configuration for inputType, like multi selection for select 
    ...
    orderNumbe?: number;    // deafault alphabatical order in display name
}
...
console.log("TASK_SETTINGS_LIST: ", TASK_SETTINGS_LIST);

import '@classes/constants/task-setting-regestery';