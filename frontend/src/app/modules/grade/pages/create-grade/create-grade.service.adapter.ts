...
export class CreateGradeServiceAdapter {
    ...
    initializeData(): void {
        ...
        this.vm.gradeService.getObjectList(this.vm.gradeService.grade, request_grade_data).then(
            (value) => {
    ...
    createGrade() {
        if (this.vm.newGradeName == null || this.vm.newGradeName == '') {
            alert('Name should be populated');
            return;
        }

        if (this.vm.newSubGradeName == null || this.vm.newSubGradeName == '') {
        ...
        this.vm.gradeService.createObject(this.vm.gradeService.grade, data).then(
            (value) => {
                ...
                this.vm.gradeService.createObject(this.vm.gradeService.sub_grade, sub_grade_data).then(
                    (value_subgrade) => {
    ...
    createSubGrade(grade: any) {
        if (this.vm.subGradeNameToBeAdded == null || this.vm.subGradeNameToBeAdded == '') {
            alert('Name should be populated');
            return;
        }
        ...
        this.vm.gradeService.createObject(this.vm.gradeService.sub_grade, data).then(
            (value) => {
    ...
    deleteSubGrade(grade: any, subGrade: any) {
        ...
        this.vm.gradeService
            .deleteObject(this.vm.gradeService.sub_grade, data)
            .then((value) => {
                this.vm.whichSubGradeIsUpdated = null;
