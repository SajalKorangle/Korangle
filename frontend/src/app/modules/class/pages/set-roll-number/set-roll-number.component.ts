...
export class SetRollNumberComponent implements OnInit {
    ...
    constructor(public studentService: StudentService, public classService: ClassService, private cdRef: ChangeDetectorRef) {}
    ...
    containsStudent(classs, section) {
        return (
            this.studentList.find((student) => {
                return student['studentSection'].parentClass == classs.id && student['studentSection'].parentDivision == section.id;
            }) != undefined
        );
    }
    ...
    getFilteredStudentList(): any {
        return this.studentList
            .filter((student) => {
                return (
                    student.studentSection.parentClass == this.selectedClass &&
