...
export class AssignClassComponent implements OnInit {
    ...
    getEmployeeAttendancePermissionList(employee: any): void {
        ...
        this.isLoading = true;
        this.attendanceService.getAttendancePermissionList(data, this.user.jwt).then(
    ...
    showAddButton(): boolean {
        ...
        this.selectedEmployeeAttendancePermissionList.every((attendancePermission) => {
            if (
                attendancePermission.parentDivision === this.selectedClass.selectedSection.id &&
    ...
    addAttendancePermission(): void {
        ...
        this.attendanceService.giveAttendancePermission(data, this.user.jwt).then(
            (result) => {
    ...
    deleteAttendancePermission(attendancePermission: any): void {
        ...
        this.attendanceService.deleteAttendancePermission(data, this.user.jwt).then(
            (result) => {
                alert(result);
