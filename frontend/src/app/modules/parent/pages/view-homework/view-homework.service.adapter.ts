...
export class ViewHomeworkServiceAdapter {
        ...
        Promise.all([
            ...
            (firstValue) => {
                ...
                Promise.all([
                    ...
                    this.completedHomeworksIdList.sort((a, b) => {
                        return a - b;
                    });
                    ...
                    Promise.all([
                        ...
                        this.initializePendingHomeworkList(
                            thirdValue[0],
                            secondValue[1],
                            secondValue[0],
                            this.classSubjectList,
    ...
    initializePendingHomeworkList(
        homeworkList: any,
        givenHomeworkList: any,
        resubmitHomeworkList: any,
        classSubjectList: any,
        subjectList: any
    ): any {
    ...
    getHomeworkDetails(homework: any) {
        ...
        Promise.all([
            this.vm.homeworkService.getObjectList(this.vm.homeworkService.homework_question_image, {
                parentHomeworkQuestion: homework.dbId,
            }),
            this.vm.homeworkService.getObjectList(this.vm.homeworkService.homework_answer_image, {
                parentHomeworkAnswer__parentHomeworkQuestion: homework.dbId,
                parentHomeworkAnswer__parentStudent: this.vm.selectedStudent,
            }),
        ]).then((value) => {
            ...
            this.vm.currentHomeworkAnswerImages.sort((a, b) =>
