...
export class CreateSchoolServiceAdapter {
    ...
    public initializeData(): void {
        ...
        this.vm.schoolService.getObjectList(this.vm.schoolService.board, {}).then(
            (value) => {
    ...
    public createSchool(data: any): void {
        ...
        this.vm.schoolOldService.createSchoolProfile(data, this.vm.user.jwt).then((value) => {
            ...
            Promise.all([
                ...
                this.vm.employeeService.addEmployeePermissionList(request_employee_permission_data, this.vm.user.jwt).then(
                    (value) => {
    ...
    getPincodeDetails(): void {
        ...
        this.vm.pincodeService.getDetailsFromPincode(this.vm.schoolProfile.pincode.toString()).then(
            (pincodeList) => {
