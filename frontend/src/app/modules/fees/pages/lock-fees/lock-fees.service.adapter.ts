...
export class LockFeesServiceAdapter {
    ...
    initializeData(): void {
        ...
        this.vm.feeService.getObjectList(this.vm.feeService.lock_fees, lock_fee_list).then(
            (value) => {
                if (value.length == 0) {
    ...
    lockFees(): void {
        ...
        this.vm.feeService.createObject(this.vm.feeService.lock_fees, lock_fee_object).then(
            (value) => {
    ...
    unlockFees(): void {
        ...
        this.vm.feeService.deleteObject(this.vm.feeService.lock_fees, this.vm.lockFees).then(
            (value) => {
