...
export class DesignTCComponent implements OnInit, OnDestroy {
  ...
  currentLayout: { id?: any, parentSchool: string, name: string, thumbnail?:string, publiclyShared:boolean, content: any, parentStudentSection?:number };
  ...
  publicLayoutList: { id?: any, parentSchool: string, name: string, thumbnail?:string, publiclyShared:boolean, content: any, parentStudentSection?:number }[] = [];
  sharedLayoutList: { id?: any, parentSchool: string, name: string, thumbnail?:string, publiclyShared:boolean, content: any, parentStudentSection?:number }[] = [];
