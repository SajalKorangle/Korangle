...
export class LayerReplacementDialogComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<LayerReplacementDialogComponent>, @Inject(MAT_DIALOG_DATA) public data: { [key: string]: any }) {
    this.ca = data.ca;
    this.layer = data.layer;
    this.parameterList = this.ca.vm.htmlAdapter.parameterList.filter(parameterAsset => parameterAsset.layerType == this.layer.constructor);
  }
