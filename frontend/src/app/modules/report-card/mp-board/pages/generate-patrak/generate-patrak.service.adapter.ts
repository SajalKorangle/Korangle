...
export class GeneratePatrakServiceAdapter {
    ...
    populateStudentFinalReportCard(): void {
        this.vm.studentFinalReportCardList = this.vm.selectedClass.studentList.sort((a, b) => {
            ...
            if (a.category == 'SC') {
                return -1;
            } else if (a.category == 'ST' && b.category != 'SC') {
                return -1;
            } else if (a.category == 'OBC' && b.category != 'SC' && b.category != 'ST') {
                return -1;
            } else if (a.category == 'Gen.' && b.category != 'SC' && b.category != 'ST' && b.category != 'OBC') {
                return -1;
            } else if (a.category == null && b.category != 'SC' && b.category != 'ST' && b.category != 'OBC' && b.category != 'Gen.') {
                return -1;
            }
            return 1;
        });
