...
import DefaultReportCard from './../../class/report-card'
...
@Component({
    ...
    providers: [ReportCardService, ClassService, StudentService, SchoolService],
})
...
export class GenerateReportCardComponent implements OnInit {
    ...
    printReportCards = async () => {
        ...
        const card = new DefaultReportCard(
            this.printMultiple,
