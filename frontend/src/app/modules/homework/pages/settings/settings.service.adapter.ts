...
export class SettingsServiceAdapter {
        ...
        Promise.all([
            ...
            (value) => {
                if (value[0].length == 0) {
                    ...
                    Promise.all([this.vm.homeworkService.createObject(this.vm.homeworkService.homework_settings, tempSettings)]).then(
                        (value) => {
    ...
    updateSettings(): any {
        ...
        Promise.all([this.vm.homeworkService.partiallyUpdateObject(this.vm.homeworkService.homework_settings, tempSettings)]).then(
            (value) => {
