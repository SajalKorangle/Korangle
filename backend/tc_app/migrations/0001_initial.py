# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2021-02-27 12:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnail', models.ImageField(null=True, upload_to='report_cards/layout_thumbnails')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('Generated', 'Generated'), ('Issued', 'Issued'), ('Cancelled', 'Cancelled')], max_length=20)),
                ('cancelledBy', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='cancelled_tc_set', to='employee_app.Employee')),
                ...
                ('issuedBy', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='issued_tc_set', to='employee_app.Employee')),
                ('parentStudent', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='transferCertificateNew', to='student_app.Student')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lastCertificateNumber', models.IntegerField(default=0)),
