...
class Easebuzz:
    ...
    *
    ...
    def easebuzzResponse(self, params):
        ...
        # Korangle Comment Starts  -- removed json.dump(result) because result is already in dict form 
        return result
        # Korangle Comment Ends
    
    def getRefundStatus(self):
        from . import refund_status
        result = refund_status.refund_status(self.MERCHANT_KEY,self.SALT,self.ENV)
