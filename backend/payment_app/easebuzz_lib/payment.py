...
def _payment(params, merchant_key, salt, env):
    ...
    # Korangle Comment Starts -- Below line has been commented because python 3 dicts dont support mutable
...
def _removeSpaceAndPreparePostArray(params):
    ...
    temp_distionary = {
      ...
      # Korangle Comment Starts-- Fields added for Korangle requirements
      'show_payment_mode' : params['show_payment_mode'].strip(),
      'split_payments': params['split_payments'].strip()
      # Korangle Comment Ends
    }
