...
def create_list(data_list, Model, ModelSerializer, GET_data):
    return_data = []
    for data in data_list:
        return_data.append(create_object(data, Model, ModelSerializer, GET_data))
    return return_data


def create_object(data, Model, ModelSerializer, GET_data):
    serializer = ModelSerializer(data=data)
    assert serializer.is_valid(**GET_data), serializer.errors
    serializer.save()
    return serializer.data


def update_list(data_list, Model, ModelSerializer, GET_data):
    return_data = []
    for data in data_list:
        return_data.append(update_object(data, Model, ModelSerializer, GET_data))
    return return_data


def update_object(data, Model, ModelSerializer, GET_data):
    ...
    if serializer.is_valid(**GET_data):
        serializer.save()
        return serializer.data
    else:
...
def partial_update_list(data_list, Model, ModelSerializer, GET_data):
    return_data = []
    for data in data_list:
        return_data.append(partial_update_object(data, Model, ModelSerializer, GET_data))
    return return_data


def partial_update_object(data, Model, ModelSerializer, GET_data):
