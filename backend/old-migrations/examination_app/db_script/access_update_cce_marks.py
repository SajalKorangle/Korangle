...
def access_update_cce_marks(apps, schema_editor):
    ...
    task_object_one = Task(path='update_cce_marks', title='Update CCE marks', orderNumber=4, parentModule=module_object)
