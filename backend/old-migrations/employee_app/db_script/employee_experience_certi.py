...
def employee_experience_certi(apps, schema_editor):
    ...
    task_object_one = Task(path='employee_experience_certi', title='Experience Certificate', orderNumber=6, parentModule=module_object)
