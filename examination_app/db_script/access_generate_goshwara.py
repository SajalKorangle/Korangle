...
def access_generate_goshwara(apps, schema_editor):
    ...
    task_object_one = Task(path='generate_goshwara', title='Generate Goshwara', orderNumber=10, parentModule=module_object)
